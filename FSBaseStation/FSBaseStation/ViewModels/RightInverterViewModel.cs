...
{
    /// RightInverterViewModel - Jacob Monger
    /// <summary>
    /// data sub view view model to RightInverter  - sets up and graphs data
    /// </summary>
    public class RightInverterViewModel : ObservableObject
    {
        ...
        {
            if (Properties.Settings.Default.RightInverterSpeedXLag != Graph1Previous)
            {
                Properties.Settings.Default.Save();
            }
            if (Properties.Settings.Default.RightInverterSpeedXLag > Properties.Settings.Default.RightInverterSpeedXLagMax)
            {
                Properties.Settings.Default.RightInverterSpeedXLag = (int)Properties.Settings.Default.RightInverterSpeedXLagMax;
                Properties.Settings.Default.Save();
            }
            Graph1Previous = Properties.Settings.Default.RightInverterSpeedXLag;
            ...
            Graph1AxisStep = TimeSpan.FromSeconds((double)Graph1Previous / Properties.Settings.Default.RightInverterSpeedXLagSpacing).Ticks;

            if (Properties.Settings.Default.RightInverterMechanicalPowerXLag != Graph2Previous)
            {
                Properties.Settings.Default.Save();
            }
            if (Properties.Settings.Default.RightInverterMechanicalPowerXLag > Properties.Settings.Default.RightInverterMechanicalPowerXLagMax)
            {
                Properties.Settings.Default.RightInverterMechanicalPowerXLag = (int)Properties.Settings.Default.RightInverterMechanicalPowerXLagMax;
                Properties.Settings.Default.Save();
            }
            Graph2Previous = Properties.Settings.Default.RightInverterMechanicalPowerXLag;
            ...
            Graph2AxisStep = TimeSpan.FromSeconds((double)Graph2Previous / Properties.Settings.Default.RightInverterMechanicalPowerXLagSpacing).Ticks;

            if (Properties.Settings.Default.RightInverterAbsolutePhaseCurrentXLag != Graph3Previous)
            {
                Properties.Settings.Default.Save();
            }
            if (Properties.Settings.Default.RightInverterAbsolutePhaseCurrentXLag > Properties.Settings.Default.RightInverterAbsolutePhaseCurrentXLagMax)
            {
                Properties.Settings.Default.RightInverterAbsolutePhaseCurrentXLag = (int)Properties.Settings.Default.RightInverterAbsolutePhaseCurrentXLagMax;
                Properties.Settings.Default.Save();
            }
            Graph3Previous = Properties.Settings.Default.RightInverterAbsolutePhaseCurrentXLag;
            ...
            Graph3AxisStep = TimeSpan.FromSeconds((double)Graph3Previous / Properties.Settings.Default.RightInverterAbsolutePhaseCurrentXLagSpacing).Ticks;

            if (Properties.Settings.Default.RightInverterLinkVoltageDCXLag != Graph4Previous)
            {
                Properties.Settings.Default.Save();
            }
            if (Properties.Settings.Default.RightInverterLinkVoltageDCXLag > Properties.Settings.Default.RightInverterLinkVoltageDCXLagMax)
            {
                Properties.Settings.Default.RightInverterLinkVoltageDCXLag = (int)Properties.Settings.Default.RightInverterLinkVoltageDCXLagMax;
                Properties.Settings.Default.Save();
            }
            Graph4Previous = Properties.Settings.Default.RightInverterLinkVoltageDCXLag;
            ...
            Graph4AxisStep = TimeSpan.FromSeconds((double)Graph4Previous / Properties.Settings.Default.RightInverterLinkVoltageDCXLagSpacing).Ticks;
