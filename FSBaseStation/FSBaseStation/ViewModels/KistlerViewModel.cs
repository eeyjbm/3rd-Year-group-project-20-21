...
{
    /// KistlerViewModel - Jacob Monger
    /// <summary>
    /// data sub view view model to KistlerViewModel  - sets up and graphs data
    /// </summary>
    public class KistlerViewModel : ObservableObject
    {
        ...
        {
            if (Properties.Settings.Default.KistlerVelXXLag != Graph1Previous)
            {
                Properties.Settings.Default.Save();
            }
            if (Properties.Settings.Default.KistlerVelXXLag > Properties.Settings.Default.KistlerVelXXLagMax)
            {
                Properties.Settings.Default.KistlerVelXXLag = (int)Properties.Settings.Default.KistlerVelXXLagMax;
                Properties.Settings.Default.Save();
            }
            Graph1Previous = Properties.Settings.Default.KistlerVelXXLag;
            ...
            Graph1AxisStep = TimeSpan.FromSeconds((double)Graph1Previous / Properties.Settings.Default.KistlerVelXXLagSpacing).Ticks;

            if (Properties.Settings.Default.KistlerVelYXLag != Graph2Previous)
            {
                Properties.Settings.Default.Save();
            }
            if (Properties.Settings.Default.KistlerVelYXLag > Properties.Settings.Default.KistlerVelYXLagMax)
            {
                Properties.Settings.Default.KistlerVelYXLag = (int)Properties.Settings.Default.KistlerVelYXLagMax;
                Properties.Settings.Default.Save();
            }
            Graph2Previous = Properties.Settings.Default.KistlerVelYXLag;
            ...
            Graph2AxisStep = TimeSpan.FromSeconds((double)Graph2Previous / Properties.Settings.Default.KistlerVelYXLagSpacing).Ticks;

            {
                Properties.Settings.Default.Save();
            }
            if (Properties.Settings.Default.KistlerAcclerationXXLag > Properties.Settings.Default.KistlerAcclerationXXLagMax)
            {
                Properties.Settings.Default.KistlerAcclerationXXLag = (int)Properties.Settings.Default.KistlerAcclerationXXLagMax;
                Properties.Settings.Default.Save();
            }
            Graph3Previous = Properties.Settings.Default.KistlerAcclerationXXLag;
            ...
            Graph3AxisStep = TimeSpan.FromSeconds((double)Graph3Previous / Properties.Settings.Default.KistlerAcclerationXXLagSpacing).Ticks;
                                                                                                        
            if (Properties.Settings.Default.KistlerAcclerationYXLag != Graph4Previous)
            {
                Properties.Settings.Default.Save();
            }
            if (Properties.Settings.Default.KistlerAcclerationYXLag > Properties.Settings.Default.KistlerAcclerationYXLagMax)
            {
                Properties.Settings.Default.KistlerAcclerationYXLag = (int)Properties.Settings.Default.KistlerAcclerationYXLagMax;
                Properties.Settings.Default.Save();
            }
            Graph4Previous = Properties.Settings.Default.KistlerAcclerationYXLag;
            ...
            Graph4AxisStep = TimeSpan.FromSeconds((double)Graph4Previous / Properties.Settings.Default.KistlerAcclerationYXLagSpacing).Ticks;
