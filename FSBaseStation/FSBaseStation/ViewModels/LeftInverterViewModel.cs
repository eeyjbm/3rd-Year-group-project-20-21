...
{
    /// LeftInverterViewModel - Jacob Monger
    /// <summary>
    /// data sub view view model to LeftInverter  - sets up and graphs data
    /// </summary>
    public class LeftInverterViewModel : ObservableObject
    {
        ...
        public void AddPoints()
        {
            ...
            for (int counter = Graph1ChartValues.Count; (int)Properties.Settings.Default.LeftInverterSpeedXNofDataPoint < counter; counter--)
            {
                Graph1ChartValues.RemoveAt(0);
            }
            for (int counter = Graph2ChartValues.Count; (int)Properties.Settings.Default.LeftInverterMechanicalPowerXNofDataPoint < counter; counter--)
            {
                Graph2ChartValues.RemoveAt(0);
            }
            for (int counter = Graph3ChartValues.Count; (int)Properties.Settings.Default.LeftInverterAbsolutePhaseCurrentXNofDataPoint < counter; counter--)
            {
                Graph3ChartValues.RemoveAt(0);
            }
            for (int counter = Graph4ChartValues.Count; (int)Properties.Settings.Default.LeftInverterLinkVoltageDCXNofDataPoint < counter; counter--)
            {
        ...
        {
            if (Properties.Settings.Default.LeftInverterSpeedXLag != Graph1Previous)
            {
                Properties.Settings.Default.Save();
            }
            if (Properties.Settings.Default.LeftInverterSpeedXLag > Properties.Settings.Default.LeftInverterSpeedXLagMax)
            {
                Properties.Settings.Default.LeftInverterSpeedXLag = (int)Properties.Settings.Default.LeftInverterSpeedXLagMax;
                Properties.Settings.Default.Save();
            }
            Graph1Previous = Properties.Settings.Default.LeftInverterSpeedXLag;
            ...
            Graph1AxisStep = TimeSpan.FromSeconds((double)Graph1Previous / Properties.Settings.Default.LeftInverterSpeedXLagSpacing).Ticks;

            if (Properties.Settings.Default.LeftInverterMechanicalPowerXLag != Graph2Previous)
            {
                Properties.Settings.Default.Save();
            }
            if (Properties.Settings.Default.LeftInverterMechanicalPowerXLag > Properties.Settings.Default.LeftInverterMechanicalPowerXLagMax)
            {
                Properties.Settings.Default.LeftInverterMechanicalPowerXLag = (int)Properties.Settings.Default.LeftInverterMechanicalPowerXLagMax;
                Properties.Settings.Default.Save();
            }
            Graph2Previous = Properties.Settings.Default.LeftInverterMechanicalPowerXLag;
            ...
            Graph2AxisStep = TimeSpan.FromSeconds((double)Graph2Previous / Properties.Settings.Default.LeftInverterMechanicalPowerXLagSpacing).Ticks;

            if (Properties.Settings.Default.LeftInverterAbsolutePhaseCurrentXLag != Graph3Previous)
            {
                Properties.Settings.Default.Save();
            }
            if (Properties.Settings.Default.LeftInverterAbsolutePhaseCurrentXLag > Properties.Settings.Default.LeftInverterAbsolutePhaseCurrentXLagMax)
            {
                Properties.Settings.Default.LeftInverterAbsolutePhaseCurrentXLag = (int)Properties.Settings.Default.LeftInverterAbsolutePhaseCurrentXLagMax;
                Properties.Settings.Default.Save();
            }
            Graph3Previous = Properties.Settings.Default.LeftInverterAbsolutePhaseCurrentXLag;
            ...
            Graph3AxisStep = TimeSpan.FromSeconds((double)Graph3Previous / Properties.Settings.Default.LeftInverterAbsolutePhaseCurrentXLagSpacing).Ticks;

            if (Properties.Settings.Default.LeftInverterLinkVoltageDCXLag != Graph4Previous)
            {
                Properties.Settings.Default.Save();
            }
            if (Properties.Settings.Default.LeftInverterLinkVoltageDCXLag > Properties.Settings.Default.LeftInverterLinkVoltageDCXLagMax)
            {
                Properties.Settings.Default.LeftInverterLinkVoltageDCXLag = (int)Properties.Settings.Default.LeftInverterLinkVoltageDCXLagMax;
                Properties.Settings.Default.Save();
            }
            Graph4Previous = Properties.Settings.Default.LeftInverterLinkVoltageDCXLag;
            ...
            Graph4AxisStep = TimeSpan.FromSeconds((double)Graph4Previous / Properties.Settings.Default.LeftInverterLinkVoltageDCXLagSpacing).Ticks;
