...
{
    /// ECUViewModel - Jacob Monger
    /// <summary>
    /// data sub view view model to ECU  - sets up and graphs data
    /// </summary>
    public class ECUViewModel : ObservableObject
    {
        ...
        {
            if (Properties.Settings.Default.ECULeftTorqueDemandXLag != Graph1Previous)
            {
                Properties.Settings.Default.Save();
            }
            if (Properties.Settings.Default.ECULeftTorqueDemandXLag > Properties.Settings.Default.ECULeftTorqueDemandXLagMax)
            {
                Properties.Settings.Default.ECULeftTorqueDemandXLag = (int)Properties.Settings.Default.ECULeftTorqueDemandXLagMax;
                Properties.Settings.Default.Save();
            }
            Graph1Previous = Properties.Settings.Default.ECULeftTorqueDemandXLag;
            ...
            Graph1AxisStep = TimeSpan.FromSeconds((double)Graph1Previous / Properties.Settings.Default.ECULeftTorqueDemandXLagSpacing).Ticks;

            if (Properties.Settings.Default.ECURightTorqueDemandXLag != Graph2Previous)
            {
                Properties.Settings.Default.Save();
            }
            if (Properties.Settings.Default.ECURightTorqueDemandXLag > Properties.Settings.Default.ECURightTorqueDemandXLagMax)
            {
                Properties.Settings.Default.ECURightTorqueDemandXLag = (int)Properties.Settings.Default.ECURightTorqueDemandXLagMax;
                Properties.Settings.Default.Save();
            }
            Graph2Previous = Properties.Settings.Default.ECURightTorqueDemandXLag;
            ...
            Graph2AxisStep = TimeSpan.FromSeconds((double)Graph2Previous / Properties.Settings.Default.ECURightTorqueDemandXLagSpacing).Ticks;

            if (Properties.Settings.Default.ECUAcclerationDemandXLag != Graph3Previous)
            {
                Properties.Settings.Default.Save();
            }
            if (Properties.Settings.Default.ECUAcclerationDemandXLag > Properties.Settings.Default.ECUAcclerationDemandXLagMax)
            {
                Properties.Settings.Default.ECUAcclerationDemandXLag = (int)Properties.Settings.Default.ECUAcclerationDemandXLagMax;
                Properties.Settings.Default.Save();
            }
            Graph3Previous = Properties.Settings.Default.ECUAcclerationDemandXLag;
            ...
            Graph3AxisStep = TimeSpan.FromSeconds((double)Graph3Previous / Properties.Settings.Default.ECUAcclerationDemandXLagSpacing).Ticks;

            if (Properties.Settings.Default.ECUFrontBrakeDemandXLag != Graph4Previous)
            {
                Properties.Settings.Default.Save();
            }
            if (Properties.Settings.Default.ECUFrontBrakeDemandXLag > Properties.Settings.Default.ECUFrontBrakeDemandXLagMax)
            {
                Properties.Settings.Default.ECUFrontBrakeDemandXLag = (int)Properties.Settings.Default.ECUFrontBrakeDemandXLagMax;
                Properties.Settings.Default.Save();
            }
            Graph4Previous = Properties.Settings.Default.ECUFrontBrakeDemandXLag;
            ...
            Graph4AxisStep = TimeSpan.FromSeconds((double)Graph4Previous / Properties.Settings.Default.ECUFrontBrakeDemandXLagSpacing).Ticks;
